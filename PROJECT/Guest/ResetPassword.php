...
if(isset($_POST["btnreset"]))
{
	if($_POST["txtnew"]==$_POST["txtconfirm"])
	{
		...
		// $sell="select * from tbl_labour where labour_email='".$_SESSION["femail"]."'";
		...
		// {
		// 	$up="update tbl_labour set labour_password='".$_POST["txtnew"]."' where labour_email='".$_SESSION["femail"]."'";
		// 	$conn->query($up);
		// }
