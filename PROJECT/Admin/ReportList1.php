        ...
        <table id="example" class="table table-striped table-bordered" cellspacing="0" width="100%">
			 ...
			 $selQry = "select * from tbl_category";
				 ...
				 $rs = $conn->query($selQry);
                   while ($data = $rs->fetch_assoc()) 
				   {
					   ...
					   $selQry2 = "select COALESCE(SUM(cart_qty),0) as qty from tbl_booking b inner join tbl_cart c on c.booking_id=b.booking_id  inner join tbl_product p on p.prod_id=c.prod_id inner join tbl_subcat s on s.subcat_id=p.subcat_id inner join tbl_category ca on ca.cat_id=s.cat_id where ca.cat_id='".$data["cat_id"]."'";
					 // echo $selQry2;
			...
			?>
              <tr>
                 ...
                 <td align="center"><?php echo $data["cat_name"]; ?></td>
