    ...
    <div class="offcanvas-menu-wrapper">
        <div class="offcanvas__cart">
            <div class="offcanvas__cart__links">
                <a href="#" class="search-switch"><img src="Assets/Template/Main/img/icon/search.png" alt=""></a>
                <a href="#"><img src="Assets/Template/Main/img/icon/heart.png" alt=""></a>
            </div>
            <div class="offcanvas__cart__item">
                <a href="#"><img src="Assets/Template/Main/img/icon/cart.png" alt=""> <span>0</span></a>
                        ...
                        <div class="header__top__inner">
                            <div class="header__top__left">
                                <ul>
                                    ...
                                    <li><a href="Guest/Login.php">Sign in</a> </span></li>      
                                </ul>
                            </div>
                            <div class="header__logo">
                                <a href="./index.php"><img src="Assets/Template/Admin/assets/images/logo/logo.jpg"  style="height: 100px;width:150px;padding-bottom: 30px;" alt=""></a>
                            </div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-lg-8">
                            <div class="hero__text">
                                ...
                                <a href="Guest/Login.php" style="z-index:1" class="primary-btn">Our cakes</a>
                            </div>
                        </div>
                    </div>
                </div>
