    ...
    <div style="padding: 30px;" align="center">
        ...
        <br>
            <div class="column-labels">
                ...
                <label class="product-price" style="width: 9%; text-align:center">KG</label>
                <label class="product-price" style="width: 0%; text-align:center">Note </label>
...
<form method="post">
        <div class="shopping-cart" style="margin-top: 50px">            <?php                
            ...
            $res = $conn->query($sel);
                while ($row=$res->fetch_assoc()) {
                    $selPr = "select * from tbl_product p inner join tbl_subcat sc on sc.subcat_id=p.subcat_id inner join tbl_category c on c.cat_id=sc.cat_id where prod_id='" .$row["prod_id"]. "'";
            ...
            <div class="product">
                <div class="product-image">
                    <img
                        src="../Assets/Files/Product/<?php echo $rowpr["prod_img"] ?>"
                        />
                </div>
    ...
    $rowO=$conn->query($selO);
                ...
                <div class="product-quantity">
                    <input alt="<?php echo $row["cart_id"] ?>" type="number" onchange="qty(this)" value="<?php echo $row["cart_qty"] ?>" min="1" />
                </div>
                <div class="product-kg" style="padding:20px">
                ...
                ?>
                    <div class="product-quantity">
                        <input alt="<?php echo $row["cart_id"] ?>" type="number" onchange="qty2(this)" value="<?php echo $row["cart_qty"] ?>" min="1" />
                    </div>
                    <div class="product-kg">
                        <input alt="<?php echo $row["cart_id"] ?>" type="number" step="0.5" onchange="kgUp(this)" value="<?php echo $row["cart_kg"] ?>" min="0.5" />
                        <input style="width:120px;padding-left:10px;" alt="<?php echo $row["cart_id"] ?>" type="text" onkeydown="nameUp(this)" placeholder="Write a note" value="<?php echo $row["cart_name"] ?>" />
                    </div>
                <?php
                }
                ?>
