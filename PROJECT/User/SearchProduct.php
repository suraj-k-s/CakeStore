                        ...
                        <li class="list-group-item">
                            <div class="form-check">
                                <label class="form-check-label">
                                    <input type="checkbox" onclick="changeSub(),productCheck()" class="form-check-input product_check" value="<?php echo $row["cat_id"]; ?>" id="category"><?php echo $row["cat_name"]; ?>
                                </label>
                            </div>
                        </li>
                        <?php
...
function changeSub()
            ...
            function productCheck(){
					...
					var kid = get_filter_text('kudumbashree');
					 var name = document.getElementById('name').value;


                    $.ajax({
                        url: "../Assets/AjaxPages/AjaxSearchProduct.php?action=" + action +"&category=" + category+"&subcategory=" + subcategory +"&kid=" + kid+"&name=" + name,
                        success: function(response) {
